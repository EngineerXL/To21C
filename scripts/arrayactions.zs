...
val inputenergyhatch as IItemStack[] = [<modularmachinery:blockenergyinputhatch>, <modularmachinery:blockenergyinputhatch:1>, <modularmachinery:blockenergyinputhatch:2>, <modularmachinery:blockenergyinputhatch:3>, <modularmachinery:blockenergyinputhatch:4>, <modularmachinery:blockenergyinputhatch:5>, <modularmachinery:blockenergyinputhatch:6>, <modularmachinery:blockenergyinputhatch:7>];

val cables as IItemStack[] = [<techreborn:cable:1>, <techreborn:cable>, <techreborn:cable:5>, <techreborn:cable:6>, <techreborn:cable:7>, <techreborn:cable:4>, <techreborn:part:17>, <thermaldynamics:duct_0:5>];

val inputbus as IItemStack[] = [<modularmachinery:blockinputbus>, <modularmachinery:blockinputbus:1>, <modularmachinery:blockinputbus:2>, <modularmachinery:blockinputbus:3>, <modularmachinery:blockinputbus:4>, <modularmachinery:blockinputbus:5>, <modularmachinery:blockinputbus:6>];

val outputbus as IItemStack[] = [<modularmachinery:blockoutputbus>, <modularmachinery:blockoutputbus:1>, <modularmachinery:blockoutputbus:2>, <modularmachinery:blockoutputbus:3>, <modularmachinery:blockoutputbus:4>, <modularmachinery:blockoutputbus:5>, <modularmachinery:blockoutputbus:6>];

val fluidoutput as IItemStack[] = [<modularmachinery:blockfluidoutputhatch>, <modularmachinery:blockfluidoutputhatch:1>, <modularmachinery:blockfluidoutputhatch:2>, <modularmachinery:blockfluidoutputhatch:3>, <modularmachinery:blockfluidoutputhatch:4>, <modularmachinery:blockfluidoutputhatch:5>, <modularmachinery:blockfluidoutputhatch:6>, <modularmachinery:blockfluidoutputhatch:7>];
...
val plates as IItemStack[] = [<contenttweaker:ironalloyplate>, <thermalfoundation:material:32>, <thermalfoundation:material:355>, <thermalfoundation:material:356>, <thermalfoundation:material:354>, <thermalfoundation:material:352>, <thermalfoundation:material:325>, <thermalfoundation:material:324>, <techreborn:plates:30>, <techreborn:plates:31>, <techreborn:plates:34>, <techreborn:plates:17>];

for i in plates {
	recipes.addShaped(<minecraft:piston>, [[<ore:plankWood>, <ore:plankWood>, <ore:plankWood>], [<ore:cobblestone>, i, <ore:cobblestone>], [<ore:cobblestone>, <minecraft:redstone>, <ore:cobblestone>]]); 
}

// Plates \\

val plates1 as IItemStack[] = [<contenttweaker:ironalloyplate>, <jaopca:item_platedraconium>, <thaumcraft:plate:2>, <thaumcraft:plate:3>, <techreborn:plates:34>, <techreborn:plates:36>, <immersiveengineering:metal:35>, <jaopca:item_platemeteoriciron>, <jaopca:item_plateosmium>, <techreborn:plates:17>, <techreborn:plates:19>, <techreborn:plates:30>, <techreborn:plates:31>, <techreborn:plates:32>, <techreborn:plates:33>, <extendedcrafting:material:2>, <thermalfoundation:material:32>, <thermalfoundation:material:33>, <thermalfoundation:material:320>, <thermalfoundation:material:321>, <thermalfoundation:material:322>, <thermalfoundation:material:323>, <thermalfoundation:material:324>, <thermalfoundation:material:325>, <thermalfoundation:material:326>, <thermalfoundation:material:327>, <thermalfoundation:material:328>, <thermalfoundation:material:352>, <thermalfoundation:material:353>, <thermalfoundation:material:354>, <thermalfoundation:material:355>, <thermalfoundation:material:356>, <thermalfoundation:material:357>, <thermalfoundation:material:358>, <thermalfoundation:material:359>, <contenttweaker:naquadahplate>, <contenttweaker:tiberiumplate>, <contenttweaker:slsteelplate>];

val materials3 as IItemStack[] = [<enderio:item_alloy_ingot:9>,<draconicevolution:draconium_ingot>, <thaumcraft:ingot>, <thaumcraft:ingot:1>, <techreborn:ingot:19>, <contenttweaker:magnaliumingot>, <immersiveengineering:metal:5>, <galacticraftcore:item_basic_moon>, <mekanism:ingot:1>, <techreborn:ingot:1>, <techreborn:ingot:3>, <techreborn:ingot:14>, <techreborn:ingot:15>, <techreborn:ingot:17>, <techreborn:ingot:18>, <extendedcrafting:material>, <minecraft:iron_ingot>, <minecraft:gold_ingot>, <thermalfoundation:material:128>, <thermalfoundation:material:129>, <thermalfoundation:material:130>, <thermalfoundation:material:131>, <thermalfoundation:material:132>, <thermalfoundation:material:133>, <thermalfoundation:material:134>, <thermalfoundation:material:135>, <thermalfoundation:material:136>, <thermalfoundation:material:160>, <thermalfoundation:material:161>, <thermalfoundation:material:162>, <thermalfoundation:material:163>, <thermalfoundation:material:164>, <thermalfoundation:material:165>, <thermalfoundation:material:166>, <thermalfoundation:material:167>, <contenttweaker:naquadahingot>, <extendedcrafting:material:24>, <modularmachinery:itemmodularium>];
...
val schemes as IItemStack[] = [<contenttweaker:rocketschematic>, <galacticraftcore:schematic>, <galacticraftcore:schematic:1>, <galacticraftplanets:schematic>, <galacticraftplanets:schematic:1>, <galacticraftplanets:schematic:2>];

for i in schemes {
	recipes.addShapeless(i, [i.reuse(), <minecraft:feather>.reuse(), <minecraft:dye>, <minecraft:paper>, <minecraft:paper>, <minecraft:paper>]);
}

// Solar panels \\

val solarpanel as IItemStack[] = [<techreborn:solar_panel>, <techreborn:solar_panel:1>, <techreborn:solar_panel:2>, <techreborn:solar_panel:3>, <techreborn:solar_panel:4>];
...
val stonetools = [<prospectus:item_prospector_stone>, <minecraft:stone_shovel>, <minecraft:stone_pickaxe>, <minecraft:stone_axe>, <minecraft:stone_sword>, <minecraft:stone_hoe>] as IItemStack[];
...
val woodentools as IItemStack[] = [<prospectus:item_prospector_wood>, <minecraft:wooden_shovel>, <minecraft:wooden_pickaxe>, <minecraft:wooden_axe>, <minecraft:wooden_sword>, <minecraft:wooden_hoe>]; 
...
val wyvern as IItemStack[] = [<draconicevolution:wyvern_sword>, <draconicevolution:wyvern_helm>, <draconicevolution:wyvern_bow>, <draconicevolution:wyvern_chest>, <draconicevolution:wyvern_pick>, <draconicevolution:wyvern_legs>, <draconicevolution:wyvern_shovel>, <draconicevolution:wyvern_boots>, <draconicevolution:wyvern_axe>];

val fluxed as IItemStack[] = [<redstonearsenal:tool.sword_flux>, <redstonearsenal:armor.helmet_flux>, <redstonearsenal:tool.bow_flux>, <redstonearsenal:armor.plate_flux>, <redstonearsenal:tool.pickaxe_flux>, <redstonearsenal:armor.legs_flux>, <redstonearsenal:tool.shovel_flux>, <redstonearsenal:armor.boots_flux>, <redstonearsenal:tool.axe_flux>];
...
while i < wyvern.length{
	...
	Infusion.registerRecipe("wyvern" + i, "", wyvern[i], 7, [<aspect:auram> * 50, <aspect:praecantatio> * 200, aspect * 100], fluxed[i], [<draconicevolution:wyvern_core>, <draconicevolution:wyvern_energy_core>, <contenttweaker:ultradensealloyplate>, <contenttweaker:ultradensealloyplate>, <draconicevolution:draconium_block>, <draconicevolution:draconium_block>, <calculator:enddiamond>, <calculator:enddiamond>, <minecraft:dragon_breath>, <thaumcraft:void_seed>]);
	i += 1;
}