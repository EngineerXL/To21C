...
// Bauxite \\
var bauxite = RecipeBuilder.newBuilder("bauxite", "adv_electrolyzer", 500);
...
// Ruby \\
var ruby = RecipeBuilder.newBuilder("ruby", "adv_electrolyzer", 125);
...
// Sapphire \\
var sapphire = RecipeBuilder.newBuilder("sapphire", "adv_electrolyzer", 100);
...
// Clay dust \\
var claydust = RecipeBuilder.newBuilder("claydust", "adv_electrolyzer", 20);
...
// Sand \\
var sand = RecipeBuilder.newBuilder("sand", "adv_electrolyzer", 50);
...
// Ender pearl dust \\
var epearldust = RecipeBuilder.newBuilder("epearldust", "adv_electrolyzer", 128);
...
// Calcite dust\\
var calcitedust = RecipeBuilder.newBuilder("calcitedust", "adv_electrolyzer", 110);
...
// Sodalite dust \\
var sodalitedust = RecipeBuilder.newBuilder("sodalitedust", "adv_electrolyzer", 235);
...
// Flint dust\\
var flintdust = RecipeBuilder.newBuilder("flintdust", "adv_electrolyzer", 10);
...
// Emerald dust \\
var emeralddust = RecipeBuilder.newBuilder("emeralddust", "adv_electrolyzer", 60);
...
// Peridot dust \\
var peridotdust = RecipeBuilder.newBuilder("peridotdust", "adv_electrolyzer", 70);
...
// Galena dust \\
var galenadust = RecipeBuilder.newBuilder("galenadust", "adv_electrolyzer", 235);
...
// Obsidian dust \\
var obsidiandust = RecipeBuilder.newBuilder("obsidiandust", "adv_electrolyzer", 5);
...
// Pyrope dust \\
var pyropedust = RecipeBuilder.newBuilder("pyropedust", "adv_electrolyzer", 175);
...
// Almandine dust \\
var almandinedust = RecipeBuilder.newBuilder("almandinedust", "adv_electrolyzer", 160);
...
// Spessartine dust \\
var spessartinedust = RecipeBuilder.newBuilder("spessartinedust", "adv_electrolyzer", 175);
...
// Andradite dust \\
var andraditedust = RecipeBuilder.newBuilder("andraditedust", "adv_electrolyzer", 125);
...
// Grossular dust \\
var grossulardust = RecipeBuilder.newBuilder("grossulardust", "adv_electrolyzer", 200);
...
// Uvarovite dust \\
var uvarovitedust = RecipeBuilder.newBuilder("uvarovitedust", "adv_electrolyzer", 200);
...
// Venus stone dust \\
var venusdust = RecipeBuilder.newBuilder("venusdust", "adv_electrolyzer", 30);
...
// Mars stone dust \\
var marsdust = RecipeBuilder.newBuilder("marsdust", "adv_electrolyzer", 15);
...
print("Advanced Electrolyzer.zs is loaded.");