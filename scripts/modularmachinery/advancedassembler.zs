...
val advwafer = RecipeBuilder.newBuilder("advwafer", "adv_assembler", 40);
...
val basicwafer = RecipeBuilder.newBuilder("basicwafer", "adv_assembler", 40);
...
val calculationprocessor = RecipeBuilder.newBuilder("calctulationprocessor", "adv_assembler", 80);

calculationprocessor.addEnergyPerTickInput(2048);
calculationprocessor.addItemInput(<appliedenergistics2:material:20>);
calculationprocessor.addItemInput(<appliedenergistics2:material:16>);
calculationprocessor.addItemInput(<calculator:redstoneingot> * 8);
calculationprocessor.addItemOutput(<appliedenergistics2:material:23>);
calculationprocessor.build();

// Data control circuit \\

val datacontrol = RecipeBuilder.newBuilder("datacontrol", "adv_assembler", 160);
...
val dataorb = RecipeBuilder.newBuilder("dataorb", "adv_assembler", 640);
...
val datastorage = RecipeBuilder.newBuilder("datastorage", "adv_assembler", 320);
...
val draconiccore = RecipeBuilder.newBuilder("draconiccore", "adv_assembler", 240);
...
val eliteboard = RecipeBuilder.newBuilder("eliteboard", "adv_assembler", 160);
...
val energyflow = RecipeBuilder.newBuilder("energyflow", "adv_assembler", 160);
...
val engineeringprocessor = RecipeBuilder.newBuilder("engineeringprocessor", "adv_assembler", 80);
...
val logicprocessor = RecipeBuilder.newBuilder("logicprocessor", "adv_assembler", 80);
...
val octuplecapacitor = RecipeBuilder.newBuilder("octuplecapacitor", "adv_assembler", 320);
...
val photovoltaic = RecipeBuilder.newBuilder("photovoltaic", "adv_assembler", 80);
...
val booster1 = RecipeBuilder.newBuilder("booster1", "adv_assembler", 320);
...
val landing2 = RecipeBuilder.newBuilder("landing2", "adv_assembler", 320);
...
val solarwafer = RecipeBuilder.newBuilder("solarwafer", "adv_assembler", 40);
