...
val atomicmult = RecipeBuilder.newBuilder("atomicmult", "assembly_line", 32000);
...
val creativekit = RecipeBuilder.newBuilder("creativekit", "assembly_line", 32000);
...
val creativepanel = RecipeBuilder.newBuilder("creativepanel", "assembly_line", 8000);
...
val digitalminer = RecipeBuilder.newBuilder("digitalminer", "assembly_line", 2400);
...
val envprocessor = RecipeBuilder.newBuilder("envprocessor", "assembly_line", 800);
...
val fusioncoil = RecipeBuilder.newBuilder("fusioncoil", "assembly_line", 8000);
...
val fusion = RecipeBuilder.newBuilder("fusion", "assembly_line", 3200);
...
val genprocessor = RecipeBuilder.newBuilder("genprocessor", "assembly_line", 800);
...
val isotopecore = RecipeBuilder.newBuilder("isotopecore", "assembly_line", 400);
...
val nanochip = RecipeBuilder.newBuilder("nanochip", "assembly_line", 1400);
...
val nanoboard = RecipeBuilder.newBuilder("nanoboard", "assembly_line", 1400);
...
val nanoprocessor = RecipeBuilder.newBuilder("nanoprocessor", "assembly_line", 3000);
...
val quantumcompressor = RecipeBuilder.newBuilder("quantumcompressor", "assembly_line", 2000);
...
val reactorcasing = RecipeBuilder.newBuilder("reactorcasing", "assembly_line", 1600);
...
val socket = RecipeBuilder.newBuilder("socket", "assembly_line", 2400);
...
val socketpart = RecipeBuilder.newBuilder("socketpart", "assembly_line", 1200);
...
val booster2 = RecipeBuilder.newBuilder("booster2", "assembly_line", 800);
...
val fusion2 = RecipeBuilder.newBuilder("fusion2", "assembly_line", 6400);
...
val landing3 = RecipeBuilder.newBuilder("landing3", "assembly_line", 1000);
...
val transistor = RecipeBuilder.newBuilder("transistor", "assembly_line", 800);
...
val diode = RecipeBuilder.newBuilder("diode", "assembly_line", 2400);
...
val wyverncore = RecipeBuilder.newBuilder("wyverncore", "assembly_line", 600);
